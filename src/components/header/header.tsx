  ...
  return (
    ...
    >
      ...
      <div className={cn(styles.bar, "flex items-center justify-between")}>
        <Link 
          href="/" 
          className="flex items-center justify-center cursor-pointer z-50"
          onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}
        >
          <img 
            src="/signature.png" 
            alt={config.author} 
            className="h-16 md:h-24 w-auto object-contain dark:invert scale-110 origin-left translate-y-2 md:translate-y-3" 
          />
        </Link>
